...
function () {
  function ChainXHR() {
    classCallCheck(this, ChainXHR);

    defineProperty(this, "METHODS", {
      GET: 'GET',
      POST: 'POST',
      PUT: 'PUT',
      DELETE: 'DELETE'
  ...
  createClass(ChainXHR, [{
    ...
    value: function data(_data) {
      if (_typeof_1(_data) === 'object' && _data instanceof FormData === false) _data = JSON.stringify(_data);
